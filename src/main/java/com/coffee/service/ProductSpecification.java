...
public class ProductSpecification {
    /*
        사용자가 지정한 날짜 범위의 상품 목록만 필터링 해주는  Specification입니다.
        searchDateType : 검색할 날짜 범위를 의미하는 문자열
        변환 값 : 검색된 범위의 상품 목록을 조회하기 위한 Specification 객체 정보
    */
    public static Specification<Product> hasDateRange(String searchDateType){
        return new Specification<Product>() {
            ...
            public Predicate toPredicate(Root<Product> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
                ...
                // 선택한 콤보 박스의 값을 보고, 검색 시작 일자를 계산한다.
  ...
  /*
        사용자가 지정한 특정 카테고리에 속하는 살품 목록만 필터링해주는 Specification입니다.
        category : 검색할 카테고리 문자열
        변환 값 : 해당 카테고리에 해당하는 상품 목록을 조회하기 위한 Specification 객체 정보
    */
    ...
    public static Specification<Product> hasCategory (Category category){
     ...
     /*
        사용자가 지정한 특정 키워드에 속하는 살품 목록만 필터링해주는 Specification입니다.
        keyword : 상품 이름에 포함될 문자열
        변환 값 : 상품 이름에 대한 키워드가 포함된 상품 목록을 조회하기 위한 Specification 객체 정보
    */
    ...
    public static Specification<Product> hasNameLike (String keyword){
     ...
     /*
        상품 상세 설명에 특정 키워드에 속하는 살품 목록만 필터링해주는 Specification입니다.
        keyword : 상품 설명에 포함될 문자열
        변환 값 : 상품 설명에 대한 키워드가 포함된 상품 목록을 조회하기 위한 Specification 객체 정보
    */
